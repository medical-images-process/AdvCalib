...
DATA_LIST_PATH = './dataset/voc_list/val.txt' ### + seed
IGNORE_LABEL = 255
NUM_CLASSES = 21
NUM_STEPS = 1449 # Number of images in the validation set.
RESTORE_FROM = ['snapshots/VOC_10000.pth','snapshots/VOC_15000.pth','snapshots/VOC_20000.pth']
#RESTORE_FROM =  ['snapshots/VOC_30000.pth', 'snapshots/VOC_40000.pth','snapshots/VOC_50000.pth','snapshots/VOC_60000.pth','snapshots/VOC_70000.pth','snapshots/VOC_80000.pth','snapshots/VOC_90000.pth','snapshots/VOC_100000.pth'] #'http://vllab1.ucmerced.edu/~whung/adv-semi-seg/AdvSemiSegVOC0.125-8d75b3f1.pth'
PRETRAINED_MODEL = None #'semi0.125' # None #
...
if __name__ == '__main__':
    for i in range(len(RESTORE_FROM)):
       main()
